...
class VAO{
    ...
    public:
        ...
        void linkVBO(VBO vbo1, VBO vbo2, VBO vbo3, GLuint posLayout, GLuint texLayout, GLuint instanced1Layout, GLuint instanced2Layout, GLuint instanced3Layout, GLuint instanced4Layout, GLuint heightLayout);
